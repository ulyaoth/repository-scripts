...
function getamiid ()
{
  imageid=`aws ec2 describe-images --owners $ownersid --filters "Name=name,Values=rpmbuild-redhat7-*" --query Images[].ImageId --output text`
}
...
{
  scp -oStrictHostKeyChecking=no -i rpmbuild.pem ulyaoth@$ip:/home/ulyaoth/rpmbuild/RPMS/x86_64/*debug*.rpm /Users/sbagmeijer/rpmbuild/rpms/redhat/7/x86_64/debug/ >> /dev/null 2>&1
  scp -oStrictHostKeyChecking=no -i rpmbuild.pem ulyaoth@$ip:/home/ulyaoth/rpmbuild/RPMS/x86_64/*.rpm /Users/sbagmeijer/rpmbuild/rpms/redhat/7/x86_64/os/ >> /dev/null 2>&1
  scp -oStrictHostKeyChecking=no -i rpmbuild.pem ulyaoth@$ip:/home/ulyaoth/rpmbuild/RPMS/noarch/*.rpm /Users/sbagmeijer/rpmbuild/rpms/redhat/7/x86_64/os/ >> /dev/null 2>&1
  scp -oStrictHostKeyChecking=no -i rpmbuild.pem ulyaoth@$ip:/home/ulyaoth/rpmbuild/SRPMS/*.rpm /Users/sbagmeijer/rpmbuild/rpms/redhat/7/source/ >> /dev/null 2>&1
}
